...
const Page = () => {
  ...
  const subCategoryOptions = {
    'Bracelet': ['Chain Bracelet', 'Bangle Bracelet', 'Charm Bracelet', 'Cuff Bracelet', 'Tennis Bracelet'],
    'Ring': ['Solitaire Ring', 'Eternity Ring', 'Engagement Ring', 'Wedding Band', 'Cocktail Ring', 'Signet Ring'],
    'Necklace': ['Chain Necklace', 'Pendant Necklace', 'Choker', 'Lariat', 'Statement Necklace'],
    'Earring': ['Stud Earrings', 'Hoop Earrings', 'Drop Earrings', 'Dangle Earrings', 'Ear Cuffs'],
    'Pendant': ['Solitaire Pendant', 'Locket', 'Medallion', 'Cross Pendant', 'Gemstone Pendant'],
    'Brooch': ['Floral Brooch', 'Animal Brooch', 'Vintage Brooch', 'Modern Brooch', 'Designer Brooch']
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!formData.material || !formData.mainCategory) {
        throw new Error('Material and Main Category are required fields');
      }
      ...
      alert('Jewelry product added successfully!');
          ...
          <div className="mt-4 flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                Add Jewelry (Fine Jewelry Collection)
              </h1>
              <p className="mt-1 text-sm text-gray-600">
                Add a new fine jewelry piece to your collection with detailed specifications
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-6">
              <div className="border-b border-gray-200 pb-4">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Basic jewelry details and categorization
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                    placeholder="e.g., Full Set, Limited Edition, Collector Edition"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  placeholder="Detailed jewelry description..."
                  rows={4}
                />
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                    placeholder="e.g., Switzerland, UAE"
                  />
                </div>
              </div>
            </div>

            {/* Availability & Color Section */}
            <div className="space-y-6">
              <div className="border-b border-gray-200 pb-4">
                <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Product availability and color information
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                    placeholder="Comma-separated keywords (e.g., fine jewelry, diamond ring, luxury)"
                  />
                  <p className="text-xs text-gray-500">
